...
// exit();
    ...
    $insert = mysqli_query($conn ,"INSERT INTO `sales`(`name`, `email`, `number`,`ban`, `panno`, `adharno`, `password`, `adhar_img`, `pancard_img`, `passbook_img`, `approval`) VALUES('$name','$email','$number','$ban','$panno','$adharno','$password','$adhar_data','$pan_data','$passbook_data','disapprove')");
   
   if($insert){
    echo "<script>alert('Success');window.location='sales.php';
    </script>";
   }else{
