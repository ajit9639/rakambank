...
// exit();
    ...
    // echo "INSERT INTO `authrised_hr`(`name`, `email`, `number`, `password`, `adhar_img`, `pancard_img`, `passbook_img`, `approval`) VALUES('$name','$email','$number','$password','$adhar_data','$pan_data','$passbook_data','no')";exit();

    $insert = mysqli_query($conn ,"INSERT INTO `hr`(`name`, `email`, `number`,`ban`, `panno`, `adharno`, `password`, `adhar_img`, `pancard_img`, `passbook_img`, `approval`) VALUES('$name','$email','$number','$ban','$panno','$adharno','$password','$adhar_data','$pan_data','$passbook_data','disapprove')");
   
   if($insert){
    echo "<script>alert('Success');window.location='hr.php';
    </script>";
   }else{
            ...
            <div class="body">
                <form id="sign_in" method="POST" action="#" enctype="multipart/form-data">
                    ...
                    <div class="input-group lg-input">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control" name="ban" placeholder="ban" required
                                autofocus>
                        </div>
                    </div>
                    <div class="input-group lg-input">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control" name="panno" placeholder="panno" required
                                autofocus>
                        </div>
                    </div>
                    <div class="input-group lg-input">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control" name="adharno" placeholder="adharno" required
                                autofocus>
                        </div>
                    </div>
