                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>:</strong></td>
                                            <td>
                                            <iframe <?php echo 'src="data:application/pdf;base64,' . base64_encode($row1['pancard_img']) . '"' ?>
                                                        ></iframe>
                                                </td>

                                            <td><strong>adhar_img </strong></td>
                                            <td><strong>:</strong></td>
                                            <td> <iframe <?php echo 'src="data:application/pdf;base64,' . base64_encode($row1['adhar_img']) . '"' ?>
                                                        ></iframe></td>
                                        </tr>
                                        <tr>
                                            <td><strong>passbook_img </strong></td>
                                            <td><strong>:</strong></td>
                                            <td><iframe <?php echo 'src="data:application/pdf;base64,' . base64_encode($row1['passbook_img']) . '"' ?>
                                                        ></iframe></td>

                                            <td><strong>salary_slip </strong></td>
                                            <td><strong>:</strong></td>
                                            <td><iframe <?php echo 'src="data:application/pdf;base64,' . base64_encode($row1['salary_slip']) . '"' ?>
                                                        ></iframe></td>
                                        </tr>
                                        <tr>
                                            <td><strong>photo </strong></td>
                                            <td><strong>:</strong></td>
                                            <td><iframe <?php echo 'src="data:application/pdf;base64,' . base64_encode($row1['photo']) . '"' ?>
                                                        ></iframe></td>

                                            <td><strong>property </strong></td>
                                            <td><strong>:</strong></td>
                                            <td><iframe <?php echo 'src="data:application/pdf;base64,' . base64_encode($row1['property']) . '"' ?>
                                                        ></iframe></td>
