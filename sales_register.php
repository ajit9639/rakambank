...
// exit();
    ...
    $insert = mysqli_query($conn ,"INSERT INTO `sales`(`name`, `email`, `number`, `password`, `adhar_img`, `pancard_img`, `passbook_img`, `approval`) VALUES('$name','$email','$number','$password','$adhar_data','$pan_data','$passbook_data','disapprove')");
