...
{   
    ...
    // echo "SELECT * FROM `hr` WHERE `email` = '$email' AND `password`= '$password' where `approval`='approved'";exit;
    

    $qw=mysqli_query($conn,"SELECT * FROM `hr` WHERE `email` = '$email' AND `password`= '$password' AND `approval`='approved'");
    ...
    if(mysqli_num_rows($qw) > 0)
    {
     ...
     echo '<script>window.location="hr_dashboard.php";</script>';
    }
    else
    {
                ...
                <form id="sign_in" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            ...
                            <a href="hr_register.php" class="btn btn-block bg-pink waves-effect">hr Register</a>
