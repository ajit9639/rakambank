                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover ">
                                    ...
                                    <tbody>
                                        <?php
                                   // echo  "SELECT * FROM `unloading_vehicle_in_temp` where `unloading_ref_id`='$id' AND `kata_status`='0'";exit();
                            $d = mysqli_query($conn,"select * from `unloading_vehicle_out_temp` where `unloading_ref_id`='$id' AND `status`='0'");
                            ...
                            { ?>
                                        <tr>
                                            ...
                                            <td>
                                              <!--<a style="padding:5px; padding-left:15px; padding-right:15px; font-size:14px;"
                                                    class="btn btn-info btn-lg btn-sm" data-toggle="modal"
                                                    data-target="#myModal1" href="javascript:void(0);">Enter</a>-->
