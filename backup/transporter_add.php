...
if ($type == 'delete') {
    ...
    if (isset($_POST['submit_sender'])) {
        ...
        if ($id == '') {
            mysqli_query($conn, "INSERT INTO `transporter`(`Name`, `Address`, `City`, `State`, `State_Code`, `Pin_Code`, `Mobile_No`, `alternate_Mobile_No`, `E_mail`, `Website`) VALUES ('$Name','$Address','$City','$State','$State_Code','$Pin_Code','$Mobile_No','$alternate_Mobile_No','$E_mail','$Website')");
