...
if(isset($_POST['vehicle_out'])){
  ...
  //echo "INSERT INTO `unloading_vehicle_out_temp`(`vehicle_no`,`trans_challan`, `company_challan`, `company_permit`, `tare_weight`, `gross_weight`, `shield_no`, `fuel_slip_no`, `fuel_qty`, `toll_tax_amt`, `adv_amt`, `remark`, `unloading_ref_id`,`status`) VALUES ('$vehicle_no','$trans_challan','$company_challan','$company_permit','$tare_weight','$gross_weight','$shield_no','$fuel_slip_no','$fuel_qty','$toll_tax_amt','$adv_amt','$remark','$id','0')";
    ...
    $insert = mysqli_query($conn , "INSERT INTO `unloading_vehicle_out_temp`(`vehicle_no`,`vehicle_type`,`trans_challan`, `company_challan`, `company_permit`, `tare_weight`, `gross_weight`, `shield_no`, `fuel_slip_no`, `fuel_qty`, `toll_tax_amt`, `adv_amt`, `remark`, `unloading_ref_id`,`status`) VALUES ('$vehicle_no','$vehicle_type','$trans_challan','$company_challan','$company_permit','$tare_weight','$gross_weight','$shield_no','$fuel_slip_no','$fuel_qty','$toll_tax_amt','$adv_amt','$remark','$unid','0')");
                            ...
                            <form id="sender_form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                      ...
                                      <!--<select name="vehicle_no" id="" class="form-control" required>
