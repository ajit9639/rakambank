...
{   
    ...
    // echo "SELECT * FROM `sales` WHERE `email` = '$email' AND `password`= '$password' where `approval`='approved'";exit;
    

    $qw=mysqli_query($conn,"SELECT * FROM `sales` WHERE `email` = '$email' AND `password`= '$password' AND `approval`='approved'");
    ...
    if(mysqli_num_rows($qw) > 0)
    {
     ...
     echo '<script>window.location="sales_dashboard.php";</script>';
    }
    else
    {
        ...
        <div class="card">
            <div class="body">
                <form id="sign_in" method="POST">
                    <div class="msg">sales Sign in</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            ...
                            <a href="sales_register.php" class="btn btn-block bg-pink waves-effect">sales Register</a>
