                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <select class="form-control" onchange="location = this.value;"> 
                                                    ...
                                                    <option value="update_registered.php?id=<?php echo $row['id']?>&status=approved&table=dsa">Approved</option>
                                                    <option value="update_registered.php?id=<?php echo $row['id']?>&status=disapproved&table=dsa">Disapproved</option>
                                                </select>
                                            </td>                                                                                                                                                                                                                                                                     
