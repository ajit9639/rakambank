                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <select class="form-control" onchange="location = this.value;"> 
                                                    ...
                                                    <option value="update_registered.php?id=<?php echo $row['id']?>&status=approved&table=sales">Approved</option>
                                                    <option value="update_registered.php?id=<?php echo $row['id']?>&status=disapproved&table=sales">Disapproved</option>
                                                </select>
                                            </td>                                                                                                                                                                                                                                                                     
