                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        <?php
                                    $s=1;
                                    $sql=mysqli_query($conn,"SELECT * FROM `hr`");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><span class="btn btn-success"><?php echo $row['approval']; ?></span></td>                                                                                                                                                                                                                                                                     
                                            <td>
                                            <select class="form-control" onchange="location = this.value;"> 
                                                
                                                    <option value="" selected>Status</option>
                                                    <option value="update_registered.php?id=<?php echo $row['id']?>&status=approved&table=hr">Approved</option>
                                                    <option value="update_registered.php?id=<?php echo $row['id']?>&status=disapproved&table=hr">Disapproved</option>
                                                </select>
                                            </td>                                                                                                                                                                                                                                                                     

                                            <!-- <td class="action">
                                                <a href='sell_loans.php?id=<?php echo $row["id"] ?>' class="get_id"><i
                                                        class="material-icons">create</i></a>
                                                <a href='sell_loans.php?id=<?php echo $row["id"] ?>&type=delete'
