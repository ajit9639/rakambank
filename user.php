                            ...
                            <form id="user_form" method="post" action="#">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        ...
                                        <textarea id="department" name="department" class="form-control"  ><?php if(isset($_GET['uid'])) { echo $data['department']; } ?></textarea>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" style="width:100%">
                                        <thead>
                                        <tr>
                                        <th style="text-align: left;padding-left:30px!important;">Sl No</th>
                                        <th style="text-align: left;padding-left:30px!important;">Name</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php
                                        ...
                                        ?>
                                        <tr>
                                            <td style="text-align: left;padding-left:30px!important;"><?php echo $ctr;
                                            if(isset($_GET['uid'])) {
                                            ...
                                            ?></td>
                                            <td style="text-align: left;padding-left:30px!important;"><input type="checkbox" name="pages[]" value="<?php echo $rf['id'];?>" data-id="<?php echo $rf['id'];?>" <?php if($permission == 1) { echo 'checked="checked"'; } ?> id="checkbox_<?php echo  $ctr; ?>" class="permission_chk filled-in chk-col-green" />
